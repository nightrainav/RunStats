		...
		{    
			try
			{
				...
				while (cursor.moveToNext())
				{
					...
					if (datoPintar.equals("")) datoPintar="["+cntx.getString(R.string.no_description)+"]";
					...
					codigo.append(" <tr height=21 style='height:16pt'>\n");
					codigo.append("  <td height=21 class=c642>&nbsp;</td>\n");
					codigo.append("  <td class=c732 width=210>"+cntx.getString(R.string.col_ritmo_media)+"</td>\n");
					...
					codigo.append("  <td class=c742 width=210 >"+cntx.getString(R.string.col_velocidad_media)+"</td>\n");
					...
					codigo.append(" <tr height=20 style='height:15pt'>\n");
					codigo.append("  <td height=20 class=c642>&nbsp;</td>\n");
					codigo.append("  <td class=c742 width=210 >"+cntx.getString(R.string.col_elevacion_ganada)+"</td>\n");
					...
					codigo.append(" <tr height=20 style='height:15pt'>\n");
					codigo.append("  <td height=20 class=c642>&nbsp;</td>\n");
					codigo.append("  <td class=c742 width=210 >"+cntx.getString(R.string.col_elevacion_perdida)+"</td>\n");
					...
					codigo.append(" <tr height=20 style='height:15pt'>\n");
					codigo.append("  <td height=20 class=c642>&nbsp;</td>\n");
					codigo.append("  <td class=c742 width=210 >"+cntx.getString(R.string.col_calorias)+"</td>\n");
					...
					codigo.append(" <tr height=21 style='height:16pt'>\n");
					codigo.append("  <td height=21 class=c642>&nbsp;</td>\n");
					codigo.append("  <td class=c632>"+cntx.getString(R.string.col_pausa)+"</td>\n");
