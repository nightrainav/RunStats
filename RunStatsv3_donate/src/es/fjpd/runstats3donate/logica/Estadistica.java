...
public class Estadistica
{
	...
	public void setCamposOrden(String camposOrden)
	{
		...
		// de cada consulta no sea persistente
	...
	public String getLiteralCamposFiltro()
	{
		...
		try
		{
			...
			literal = literal.replaceAll("year", RunStats.getAppContext().getString(R.string.col_anio));
			...
			if (literal.contains("month"))
			{
				...
				literal = literal.replaceAll("month=" + tmpValor, RunStats.getAppContext().getString(R.string.col_mes)+" = " + tmpDato);
			}
			...
			if (literal.contains("sportType"))
			{
				...
				literal = literal.replaceAll("sportType=" + tmpValor, RunStats.getAppContext().getString(R.string.col_tipodeporte)+" = " + tmpDato);
			}
