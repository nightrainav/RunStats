    ...
    public boolean onOptionsItemSelected(MenuItem item)
	{
        switch (item.getItemId())
		{
			...
			case R.id.action_addsort:
				...
				dialogo.setTitle(RunStats.getAppContext().getString(R.string.select_field));
				...
				dialogo.setItems(items, 
					new DialogInterface.OnClickListener()
					{
						public void onClick(DialogInterface p1, int p2)
						{
							...
							final String[] items2 = new String[]{RunStats.getAppContext().getString(R.string.order_asc), RunStats.getAppContext().getString(R.string.order_desc)};
							AlertDialog.Builder dialogo2 = new AlertDialog.Builder(ScreenSlideActivity.this);
							dialogo2.setTitle(RunStats.getAppContext().getString(R.string.select_sortorder));
			...
			case R.id.action_infofilter:
				...
				// mostramos dialogo para elegir campo
				AlertDialog.Builder dialogoif = new AlertDialog.Builder(this);
				dialogoif.setTitle(RunStats.getAppContext().getString(R.string.filter_applied));
			...
			case R.id.action_infosort:
				...
				// mostramos dialogo para elegir campo
				AlertDialog.Builder dialogois = new AlertDialog.Builder(this);
				dialogois.setTitle(RunStats.getAppContext().getString(R.string.sort_applied));
			...
			case R.id.action_addfilter:
				...
				// mostramos dialogo para elegir campo
				AlertDialog.Builder dialogof = new AlertDialog.Builder(this);
				dialogof.setTitle(RunStats.getAppContext().getString(R.string.select_field));
				...
				dialogof.setItems(itemsf, 
					new DialogInterface.OnClickListener()
					{
						public void onClick(DialogInterface p1, int p2)
						{
							...
							AlertDialog.Builder dialogof2 = new AlertDialog.Builder(ScreenSlideActivity.this);
							dialogof2.setTitle(RunStats.getAppContext().getString(R.string.select_value));
